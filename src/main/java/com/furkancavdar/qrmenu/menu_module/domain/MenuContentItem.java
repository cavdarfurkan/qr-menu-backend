...
public class MenuContentItem {
  ...
  @Setter private JsonNode data;

  public MenuContentItem(
      Menu menu, Long ownerId, Theme theme, String collectionName, JsonNode data) {
    this.menu = menu;
  ...
  public MenuContentItem(
      UUID id, Menu menu, Long ownerId, Theme theme, String collectionName, JsonNode data) {
