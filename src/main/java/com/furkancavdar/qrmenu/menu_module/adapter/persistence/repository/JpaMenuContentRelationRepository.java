...
public interface JpaMenuContentRelationRepository
    extends JpaRepository<MenuContentRelationEntity, Long> {
  ...
  List<MenuContentRelationEntity> findBySourceItem_IdAndFieldNameOrderByPositionAsc(
