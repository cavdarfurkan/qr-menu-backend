...
public class MenuContentEntityMapper {
    ...
    public static MenuContentRelationEntity toMenuContentRelationEntity(MenuContentRelation menuContentRelation) {
        ...
        menuContentRelationEntity.setSourceItem(MenuContentEntityMapper.toMenuContentItemEntity(menuContentRelation.getSourceItem()));
        menuContentRelationEntity.setFieldName(menuContentRelation.getFieldName());
        menuContentRelationEntity.setTargetItem(MenuContentEntityMapper.toMenuContentItemEntity(menuContentRelation.getTargetItem()));
        menuContentRelationEntity.setPosition(menuContentRelation.getPosition());
        return menuContentRelationEntity;
    }

    public static MenuContentRelation toMenuContentRelation(MenuContentRelationEntity menuContentRelationEntity) {
        ...
        return MenuContentRelation.builder()
                ...
                .sourceItem(MenuContentEntityMapper.toMenuContentItem(menuContentRelationEntity.getSourceItem()))
                .fieldName(menuContentRelationEntity.getFieldName())
                .targetItem(MenuContentEntityMapper.toMenuContentItem(menuContentRelationEntity.getTargetItem()))
