...
public class GlobalExceptionHandler {
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public ApiResponse<Map<String, List<String>>> handleHandlerMethodValidationException(
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public ApiResponse<String> handleHttpMessageNotReadableException(
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public ApiResponse<String> handleMethodArgumentTypeMismatchException(
