...
public class AuthenticationService implements AuthenticationUseCase {
    ...
    public Optional<LoginResultDto> login(LoginDto loginDto) {
        ...
        try {
            ...
            SessionMetadata sessionMetadata = generateSessionMetadata(
                    sessionId,
                    user.getUsername(),
                    refreshJti,
                    ipAddress,
            ...
            LoginResultDto loginResultDto = new LoginResultDto(UserDtoMapper.toUserDto(optionalUser.get()), jwtTokenPair);
    ...
    public Optional<RefreshResultDto> refreshToken(String refreshToken) {
        ...
        try {
            ...
            jwtTokenService.blacklistJti(refreshJti, "JWTs refreshed", (expirationTime + 1000L) - System.currentTimeMillis());
            ...
            Optional<SessionMetadata> optionalSessionMetadata = sessionRepository.findBySessionId(sessionId);
            SessionMetadata sessionMetadata = optionalSessionMetadata.map(metadata -> generateSessionMetadata(
            ...
            )).orElseGet(() -> generateSessionMetadata(
                    sessionId,
                    user.getUsername(),
                    newRefreshJti,
                    "",
    ...
    private SessionMetadata generateSessionMetadata(String sessionId, String username, String refreshJti, String ipAddress, String userAgentString, String refreshToken) {
