...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        tokenRepository.setCookieCustomizer(cookieBuilder -> {
        ...
        http
                ...
                .csrf(csrf -> csrf
                        ...
                        .requireCsrfProtectionMatcher(PathPatternRequestMatcher.withDefaults().matcher(HttpMethod.POST, "/api/v1/auth/refresh"))
                )
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(List.of("Authorization", "Content-Type", "X-Requested-With", "X-XSRF-TOKEN",
                "X-Request-Cookie-Secure", "X-Request-Cookie-SameSite"));
