...
public class ThemeAdapter implements ThemeRepositoryPort {
    ...
    public Theme save(Theme theme) {
        return ThemeEntityMapper.toTheme(jpaThemeRepository.save(ThemeEntityMapper.toThemeEntity(theme)));
    }

    @Override
    public Optional<Theme> findById(Long id) {
        log.info("ThemeAdapter:findById");
        return Optional.ofNullable(ThemeEntityMapper.toTheme(jpaThemeRepository.findById(id).orElse(null)));
    }
